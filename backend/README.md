...
## Project Structure
    ...
    ├── small_waterfall_dev_78951  # Django project configurations
...
1. Clone this repo and `cd small_waterfall_dev_78951`
...
2. Clone this repo and `cd small_waterfall_dev_78951`
